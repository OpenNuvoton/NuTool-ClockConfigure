...
NUTOOL_CLOCK.g_register_map.AHBCLK = ['USBHCKEN:16', 'FMCIDLE:15', 'CRPTCKEN:12', 'CRCCKEN:7', 'SDH0CKEN:6', 'EBICKEN:3', 'ISPCKEN:2', 'PDMA1CKEN:1', 'PDMA0CKEN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK0 = ['I2S0CKEN:29', 'EADCCKEN:28', 'USBDCKEN:27', 'OTGCKEN:26', 'CAN0CKEN:24', 'UART5CKEN:21', 'UART4CKEN:20', 'UART3CKEN:19', 'UART2CKEN:18', 'UART1CKEN:17', 'UART0CKEN:16', 'SPI2CKEN:15', 'SPI1CKEN:14', 'SPI0CKEN:13', 'QSPI0CKEN:12', 'I2C2CKEN:10', 'I2C1CKEN:9', 'I2C0CKEN:8', 'ACMP01CKEN:7', 'CLKOCKEN:6', 'TMR3CKEN:5', 'TMR2CKEN:4', 'TMR1CKEN:3', 'TMR0CKEN:2', 'RTCCKEN:1', 'WDTCKEN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK1 = ['ECAP1CKEN:27', 'ECAP0CKEN:26', 'TRNGCKEN:25', 'QEI1CKEN:23', 'QEI0CKEN:22', 'BPWM1CKEN:19', 'BPWM0CKEN:18', 'EPWM1CKEN:17', 'EPWM0CKEN:16', 'DACCKEN:12', 'USCI1CKEN:9', 'USCI0CKEN:8', 'SPI3CKEN:6', 'SC2CKEN:2', 'SC1CKEN:1', 'SC0CKEN:0'];
...
NUTOOL_CLOCK.g_register_map.RTC_LXTCTL = ['C32KS:7', 'LIRC32KEN:0'];
...
NUTOOL_CLOCK.g_register_map_default.CLKSEL0   = '0x0030013F';
NUTOOL_CLOCK.g_register_map_default.CLKSEL1   = '0xBF77770B';
NUTOOL_CLOCK.g_register_map_default.CLKSEL2   = '0x0000ABAB';
NUTOOL_CLOCK.g_register_map_default.CLKSEL3   = '0xFF00003F';
NUTOOL_CLOCK.g_register_map_default.PWRCTL    = '0x0004000F';
...
NUTOOL_CLOCK.g_register_map_default.PLLCTL    = '0x000D440A';
...
NUTOOL_CLOCK.g_CLKSEL.BPWM0SEL = ['PCLK0:1']; // read only
NUTOOL_CLOCK.g_CLKSEL.BPWM1SEL = ['PCLK1:1']; // read only
NUTOOL_CLOCK.g_CLKSEL.CLKOSEL = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.EPWM0SEL = ['PCLK0:1']; // read only
NUTOOL_CLOCK.g_CLKSEL.EPWM1SEL = ['PCLK1:1']; // read only
NUTOOL_CLOCK.g_CLKSEL.HCLKSEL = ['HXT:0', 'LXT:1', 'PLL:2', 'LIRC:3', 'HIRC48:5', 'HIRC:7'];
...
NUTOOL_CLOCK.g_unusedModule = {
	"M261ZIAAE": ["SPI3", "CAN0", "QEI0", "ECAP0", "ECAP1", "OTG", "EBI", "USBD", "USBH"],
	"M261SIAAE": ["CAN0", "ECAP1", "OTG", "USBD", "USBH"],
	"M261KIAAE": ["CAN0", "OTG", "USBD", "USBH"],
	"M262ZIAAE": ["SPI3", "CAN0", "QEI0", "ECAP0", "ECAP1", "EBI"],
	"M262SIAAE": ["CAN0", "ECAP1"],
	"M262KIAAE": ["CAN0"],
	"M263ZIAAE": ["SPI3", "QEI0", "ECAP0", "ECAP1", "EBI"],
	"M263SIAAE": ["ECAP1"]
};
...
NUTOOL_CLOCK.g_BusFromPCLK1 = ['ACMP01', 'DAC', 'EADC', 'ECAP1', 'I2C1', 'OTG', 'EPWM1', 'BPWM1', 'QEI1', 'RTC', 'SC1', 'SPI0', 'SPI2', 'TMR2', 'TMR3', 'TRNG', 'UART1', 'UART3', 'UART5', 'USCI1'];
NUTOOL_CLOCK.g_DIV_Module_Defines = ['USBD:USB', 'USBH:USB', 'OTG:USB'];
NUTOOL_CLOCK.g_CPUCLKLimit = 64 * 1000000;
