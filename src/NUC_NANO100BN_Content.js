...
NUTOOL_CLOCK.g_register_map.PWRCTL = ['OSC10K_EN:3', 'OSC22M_EN:2', 'XTL32K_EN:1', 'XTL12M_EN:0'];
NUTOOL_CLOCK.g_register_map.AHBCLK = ['TICK_EN:5', 'SRAM_EN:4', 'EBI_EN:3', 'ISP_EN:2', 'DMA_EN:1', 'GPIO_EN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK = ['SC1_EN:31', 'SC0_EN:30', 'I2S_EN:29', 'ADC_EN:28', 'USBD_EN:27', 'LCD_EN:26', 'DAC_EN:25', 'PWM1_CH23_EN:23', 'PWM1_CH01_EN:22', 'PWM0_CH23_EN:21', 'PWM0_CH01_EN:20', 'UART1_EN:17', 'UART0_EN:16', 'SPI2_EN:14', 'SPI1_EN:13', 'SPI0_EN:12', 'I2C1_EN:9', 'I2C0_EN:8', 'SC2_EN:7', 'FDIV_EN:6', 'TMR3_EN:5', 'TMR2_EN:4', 'TMR1_EN:3', 'TMR0_EN:2', 'RTC_EN:1', 'WDT_EN:0'];
NUTOOL_CLOCK.g_register_map.CLKSEL0 = ['HCLK_S:2-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL1 = ['TMR1_S:14-12', 'TMR0_S:10-8', 'PWM0_CH23_S:7-6', 'PWM0_CH01_S:5-4', 'ADC_S:3-2', 'UART_S:1-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['SPI2_S:22', 'SPI1_S:21', 'SPI0_S:20', 'SC_S:19-18', 'I2S_S:17-16', 'TMR3_S:14-12', 'TMR2_S:10-8', 'PWM1_CH23_S:7-6', 'PWM1_CH01_S:5-4', 'FRQDIV_S:3-2'];
NUTOOL_CLOCK.g_register_map.CLKDIV0 = ['SC0_N:31-28', 'ADC_N:23-16', 'I2S_N:15-12', 'UART_N:11-8', 'USB_N:7-4', 'HCLK_N:3-0'];
NUTOOL_CLOCK.g_register_map.CLKDIV1 = ['SC2_N:7-4', 'SC1_N:3-0'];
NUTOOL_CLOCK.g_register_map.PLLCTL = ['PLL_SRC:17', 'PD:16', 'OUT_DV:12', 'IN_DV:9-8', 'FB_DV:5-0'];
...
NUTOOL_CLOCK.g_register_map_default.CLKSEL1  = '0x0007FFFF';
NUTOOL_CLOCK.g_register_map_default.CLKSEL2  = '0x000FFFFF';
NUTOOL_CLOCK.g_register_map_default.PWRCTL   = '0x0000031F';
...
NUTOOL_CLOCK.g_register_map_default.PLLCTL   = '0x00031120';
...
NUTOOL_CLOCK.g_register_map_description.FRQDIV   = '0x50000228';
NUTOOL_CLOCK.g_register_map_description.SYST_CTL = '0xE000E010';

NUTOOL_CLOCK.g_CLKSEL = [];
NUTOOL_CLOCK.g_CLKSEL.ADC_S = ['HXT:0', 'LXT:1', 'PLL:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.FRQDIV_S = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.HCLK_S = ['HXT:0', 'LXT:1', 'PLL:2', 'LIRC:3', 'HIRC:7'];
NUTOOL_CLOCK.g_CLKSEL.I2S_S = ['HXT:0', 'PLL:1', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.PWM0_CH01_S = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.PWM0_CH23_S = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.PWM1_CH01_S = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.PWM1_CH23_S = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.SC_S = ['HXT:0', 'PLL:1', 'HIRC:3'];
...
NUTOOL_CLOCK.g_CLKSEL.TMR0_S = ['HXT:0', 'LXT:1', 'LIRC:2', 'EXT:3', 'HIRC:7']; //'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR1_S = ['HXT:0', 'LXT:1', 'LIRC:2', 'EXT:3', 'HIRC:7']; //'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR2_S = ['HXT:0', 'LXT:1', 'LIRC:2', 'EXT:3', 'HIRC:7']; //'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR3_S = ['HXT:0', 'LXT:1', 'LIRC:2', 'EXT:3', 'HIRC:7']; //'external:3'
...
NUTOOL_CLOCK.g_Module.DAC = ['PCLK', 'DAC_EN', 'none'];
...
NUTOOL_CLOCK.g_Module.I2S = ['I2S_S', 'I2S_EN', 'I2S_N'];
...
NUTOOL_CLOCK.g_Module.PWM1_CH01 = ['PWM1_CH01_S', 'PWM1_CH01_EN', 'none'];
NUTOOL_CLOCK.g_Module.PWM1_CH23 = ['PWM1_CH23_S', 'PWM1_CH23_EN', 'none'];
...
NUTOOL_CLOCK.g_Module.SC2 = ['SC_S', 'SC2_EN', 'SC2_N'];
...
NUTOOL_CLOCK.g_unusedModule = {
	"NANO100NC2BN": ["USBD", "PWM0_CH01", "PWM0_CH23", "PWM1_CH01", "PWM1_CH23", "EBI", "LCD"],
	"NANO100ND2BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100ND3BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100NE3BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100LC2BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100LD2BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100LD3BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100LE3BN": ["USBD", "PWM1_CH23", "EBI", "LCD"],
	"NANO100SC2BN": ["USBD", "EBI", "LCD"],
	"NANO100SD2BN": ["USBD", "EBI", "LCD"],
	"NANO100SD3BN": ["USBD", "EBI", "LCD"],
	"NANO100SE3BN": ["USBD", "EBI", "LCD"],
	"NANO100KD3BN": ["USBD", "LCD"],
	"NANO100KE3BN": ["USBD", "LCD"],

	"NANO110SC2BN": ["USBD", "EBI"],
	"NANO110SD2BN": ["USBD", "EBI"],
	"NANO110SD3BN": ["USBD", "EBI"],
	"NANO110SE3BN": ["USBD", "EBI"],
	"NANO110RC2BN": ["USBD", "EBI"],
	"NANO110RD2BN": ["USBD", "EBI"],
	"NANO110RD3BN": ["USBD", "EBI"],
	"NANO110RE3BN": ["USBD", "EBI"],
	"NANO110KC2BN": ["USBD"],
	"NANO110KD2BN": ["USBD"],
	"NANO110KD3BN": ["USBD"],
	"NANO110KE3BN": ["USBD"],

	"NANO120LC2BN": ["PWM1_CH01", "PWM1_CH23", "EBI", "LCD"],
	"NANO120LD2BN": ["PWM1_CH01", "PWM1_CH23", "EBI", "LCD"],
	"NANO120LD3BN": ["PWM1_CH01", "PWM1_CH23", "EBI", "LCD"],
	"NANO120LE3BN": ["PWM1_CH01", "PWM1_CH23", "EBI", "LCD"],
	"NANO120SC2BN": ["EBI", "LCD"],
	"NANO120SD2BN": ["EBI", "LCD"],
	"NANO120SD3BN": ["EBI", "LCD"],
	"NANO120SE3BN": ["EBI", "LCD"],
	"NANO120KD3BN": ["LCD"],
	"NANO120KE3BN": ["LCD"],
...
NUTOOL_CLOCK.g_CPUCLKLimit = 42 * 1000000;
