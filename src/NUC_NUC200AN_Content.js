...
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['WWDT_S:17-16', 'PWM67_S_E:11', 'PWM45_S_E:10', 'PWM23_S_E:9', 'PWM01_S_E:8', 'PWM67_S:7-6', 'PWM45_S:5-4', 'FRQDIV_S:3-2', 'I2S_S:1-0'];
...
NUTOOL_CLOCK.g_unusedModule = {
	"NUC200LC2AN": ["UART2", "SPI1", "SPI2", "SPI3", "USBD", "SC1", "PWM67"],
	"NUC200LD2AN": ["UART2", "SPI1", "SPI2", "SPI3", "USBD", "SC1", "PWM67"],
	"NUC200LE3AN": ["UART2", "SPI1", "SPI2", "SPI3", "USBD", "SC1", "PWM67"],
	"NUC200SC2AN": ["SPI2", "SPI3", "USBD", "SC1", "PWM67"],
	"NUC200SD2AN": ["SPI2", "SPI3", "USBD", "SC1", "PWM67"],
	"NUC200SE3AN": ["SPI2", "SPI3", "USBD", "SC1", "PWM67"],
	"NUC200VE3AN": ["USBD"],

	"NUC220LC2AN": ["UART2", "SPI1", "SPI2", "SPI3", "SC1", "PWM45", "PWM67"],
	"NUC220LD2AN": ["UART2", "SPI1", "SPI2", "SPI3", "SC1", "PWM45", "PWM67"],
	"NUC220LE3AN": ["UART2", "SPI1", "SPI2", "SPI3", "SC1", "PWM45", "PWM67"],
	"NUC220SC2AN": ["UART2", "SPI2", "SPI3", "SC1", "PWM67"],
	"NUC220SD2AN": ["UART2", "SPI2", "SPI3", "SC1", "PWM67"],
	"NUC220SE3AN": ["UART2", "SPI2", "SPI3", "SC1", "PWM67"]
};
