...
NUTOOL_CLOCK.g_register_map_default.AHBCLK   = '0x00000015';
...
NUTOOL_CLOCK.g_CLKSEL.TMR0SEL = ['HXTorLXT:0', 'LIRC:1', 'PCLK:2', 'EXT:3', 'HIRC:7']; //'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR1SEL = ['HXTorLXT:0', 'LIRC:1', 'PCLK:2', 'EXT:3', 'HIRC:7']; //'external:3'
NUTOOL_CLOCK.g_CLKSEL.UART0SEL = ['HXTorLXT:0', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.UART1SEL = ['HXTorLXT:0', 'HIRC:3'];
