...
NUTOOL_CLOCK.g_unusedModule = {
	"NUC100LC1DN": ["UART2", "SPI1", "SPI2", "SPI3", "USBD", "PWM67", "EBI"],
	"NUC100LD2DN": ["UART2", "SPI1", "SPI2", "SPI3", "USBD", "PWM67", "EBI"],
	"NUC100LE3DN": ["UART2", "SPI1", "SPI2", "SPI3", "USBD", "PWM67", "EBI"],
	"NUC100RC1DN": ["SPI2", "SPI3", "USBD", "PWM67"],
	"NUC100RD1DN": ["SPI2", "SPI3", "USBD", "PWM67"],
	"NUC100RD2DN": ["SPI2", "SPI3", "USBD", "PWM67"],
	"NUC100RE3DN": ["SPI2", "SPI3", "USBD", "PWM67"],
	"NUC100VE3DN": ["USBD"],

	"NUC120LC1DN": ["UART2", "SPI1", "SPI2", "SPI3", "PWM45", "PWM67", "EBI"],
	"NUC120LD2DN": ["UART2", "SPI1", "SPI2", "SPI3", "PWM45", "PWM67", "EBI"],
	"NUC120LE3DN": ["UART2", "SPI1", "SPI2", "SPI3", "PWM45", "PWM67", "EBI"],
	"NUC120RC1DN": ["UART2", "SPI2", "SPI3", "PWM67"],
	"NUC120RD2DN": ["UART2", "SPI2", "SPI3", "PWM67"],
	"NUC120RE3DN": ["UART2", "SPI2", "SPI3", "PWM67"]
};
