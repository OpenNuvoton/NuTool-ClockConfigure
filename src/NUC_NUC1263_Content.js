...
NUTOOL_CLOCK.g_register_map.AHBCLK = ['GPIOGCKEN:22', 'GPIOFCKEN:21', 'GPIOECKEN:20', 'GPIODCKEN:19', 'GPIOCCKEN:18', 'GPIOBCKEN:17', 'GPIOACKEN:16', 'FMCIDLE:15', 'CRCCKEN:7', 'ISPCKEN:2', 'PDMACKEN:1'];
NUTOOL_CLOCK.g_register_map.APBCLK0 = ['ACPM23CKEN:31', 'ACPM01CKEN:30', 'DACCKEN:29', 'ADCCKEN:28', 'USBDCKEN:27', 'SPD5CKEN:26', 'I3C1CKEN:25', 'I3C0CKEN:24', 'BPWM3CKEN:23', 'BPWM2CKEN:22', 'BPWM1CKEN:21', 'BPWM0CKEN:20', 'UART2CKEN:18', 'UART1CKEN:17', 'UART0CKEN:16', 'SPI2CKEN:14', 'SPI1CKEN:13', 'SPI0CKEN:12', 'I2C2CKEN:10', 'I2C1CKEN:9', 'I2C0CKEN:8', 'CLKOCKEN:6', 'TMR3CKEN:5', 'TMR2CKEN:4', 'TMR1CKEN:3', 'TMR0CKEN:2', 'WDTCKEN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK1 = ['LLSI5CKEN:21', 'LLSI4CKEN:20', 'LLSI3CKEN:19', 'LLSI2CKEN:18', 'LLSI1CKEN:17', 'LLSI0CKEN:16'];
NUTOOL_CLOCK.g_register_map.CLKSEL0 = ['PCLK1SEL:7', 'PCLK0SEL:6', 'STCLKSEL:5-3', 'HCLKSEL:2-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL1 = ['UART2SEL:29-28', 'UART1SEL:27-26', 'UART0SEL:25-24', 'TMR3SEL:22-20', 'TMR2SEL:18-16', 'TMR1SEL:14-12', 'TMR0SEL:10-8', 'BPWM3SEL:7', 'BPWM2SEL:6', 'BPWM1SEL:5', 'BPWM0SEL:4', 'ADCSEL:3-2', 'WDTSEL:1-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['SPI2SEL:29-28', 'SPI1SEL:27-26', 'SPI0SEL:25-24', 'WWDTSEL:17-16', 'CLKOSEL:4-2'];
NUTOOL_CLOCK.g_register_map.CLKSEL3 = ['USBDSEL:8'];
NUTOOL_CLOCK.g_register_map.CLKDIV0 = ['UART2DIV:27-24', 'ADCDIV:23-16', 'UART1DIV:15-12', 'UART0DIV:11-8', 'USBDIV:7-4', 'HCLKDIV:3-0'];
...
NUTOOL_CLOCK.g_register_map_default.CLKSEL1  = '0x3F7777FF';
NUTOOL_CLOCK.g_register_map_default.CLKSEL2  = '0x00020008';
NUTOOL_CLOCK.g_register_map_default.CLKSEL3  = '0x00000000';
NUTOOL_CLOCK.g_register_map_default.PWRCTL   = '0x0000001C';
NUTOOL_CLOCK.g_register_map_default.AHBCLK   = {
                                "NuClockConfig":     '0x007F8004',
                                "NuClockConfigTest": '0x007F8004',
                                "NuCodeGenTool":     '0x007F8004',
...
NUTOOL_CLOCK.g_CLKSEL.BPWM1SEL = ['PLL:0', 'PCLK0:1'];
NUTOOL_CLOCK.g_CLKSEL.BPWM2SEL = ['PLL:0', 'PCLK0:1'];
NUTOOL_CLOCK.g_CLKSEL.BPWM3SEL = ['PLL:0', 'PCLK0:1'];
NUTOOL_CLOCK.g_CLKSEL.CLKOSEL = ['HXT:0', 'LXT:1', 'HCLK:2', 'HIRC/2:3', 'HIRC/2:3', 'HIRC:5'];
NUTOOL_CLOCK.g_CLKSEL.HCLKSEL = ['HXT:0', 'LXT:1', 'PLL/2:2', 'LIRC:3', 'HIRC:4', 'PLL/2:5', 'HIRC/2:7'];
...
NUTOOL_CLOCK.g_CLKSEL.TMR0SEL = ['HXT:0', 'LXT:1', 'PCLK0:2', 'EXT:3', 'LIRC:5', 'HIRC/2:7']; //'external:3',
NUTOOL_CLOCK.g_CLKSEL.TMR1SEL = ['HXT:0', 'LXT:1', 'PCLK0:2', 'EXT:3', 'LIRC:5', 'HIRC/2:7']; //'external:3',
NUTOOL_CLOCK.g_CLKSEL.TMR2SEL = ['HXT:0', 'LXT:1', 'PCLK1:2', 'EXT:3', 'LIRC:5', 'HIRC/2:7']; //'external:3',
NUTOOL_CLOCK.g_CLKSEL.TMR3SEL = ['HXT:0', 'LXT:1', 'PCLK1:2', 'EXT:3', 'LIRC:5', 'HIRC/2:7']; //'external:3',
NUTOOL_CLOCK.g_CLKSEL.UART0SEL = ['HXT:0', 'PLL/2:1', 'LXT:2', 'HIRC/2:3'];
NUTOOL_CLOCK.g_CLKSEL.UART1SEL = ['HXT:0', 'PLL/2:1', 'LXT:2', 'HIRC/2:3'];
NUTOOL_CLOCK.g_CLKSEL.UART2SEL = ['HXT:0', 'PLL/2:1', 'LXT:2', 'HIRC/2:3'];
...
NUTOOL_CLOCK.g_Module.ACMP01 = ['PCLK0', 'ACPM01CKEN', 'none'];
NUTOOL_CLOCK.g_Module.ACMP23 = ['PCLK1', 'ACPM23CKEN', 'none'];
...
NUTOOL_CLOCK.g_Module.CLKO = ['CLKOSEL', 'CLKOCKEN', 'none'];
NUTOOL_CLOCK.g_Module.CRC = ['HCLK', 'CRCCKEN', 'none'];
NUTOOL_CLOCK.g_Module.DAC = ['PCLK', 'DACCKEN', 'none'];
...
NUTOOL_CLOCK.g_Module.GPIOG = ['HCLK', 'GPIOGCKEN', 'none'];
...
NUTOOL_CLOCK.g_Module.I3C0 = ['PCLK0', 'I3C0CKEN', 'none'];
NUTOOL_CLOCK.g_Module.I3C1 = ['PCLK1', 'I3C1CKEN', 'none'];
...
NUTOOL_CLOCK.g_Module.SPD5 = ['PCLK0', 'SPD5CKEN', 'none'];
