...
NUTOOL_CLOCK.g_register_map.AHBCLK = ['HDIV_EN:4', 'ISP_EN:2'];
NUTOOL_CLOCK.g_register_map.APBCLK = ['QEI1_EN:31', 'QEI0_EN:30', 'OPA_EN:29', 'ADC_EN:28', 'CAP1_EN:27', 'CAP0_EN:26', 'CAN_EN:24', 'ACMP_EN:22', 'EPWM1_EN:21', 'EPWM0_EN:20', 'BPWM_EN:19', 'MDU_EN:18', 'UART1_EN:17', 'UART0_EN:16', 'SPI2_EN:14', 'SPI1_EN:13', 'SPI0_EN:12', 'I2C_EN:8', 'FDIV_EN:6', 'TMR3_EN:5', 'TMR2_EN:4', 'TMR1_EN:3', 'TMR0_EN:2', 'WDT_EN:0'];
...
NUTOOL_CLOCK.g_Module.ADC = ['PCLK', 'ADC_EN', 'ADC_N'];
NUTOOL_CLOCK.g_Module.BPWM = ['PCLK', 'BPWM_EN', 'none'];
NUTOOL_CLOCK.g_Module.CAN = ['PCLK', 'CAN_EN', 'none'];
NUTOOL_CLOCK.g_Module.CAP0 = ['PCLK', 'CAP0_EN', 'none'];
NUTOOL_CLOCK.g_Module.CAP1 = ['PCLK', 'CAP1_EN', 'none'];
...
NUTOOL_CLOCK.g_Module.MDU = ['PCLK', 'MDU_EN', 'none'];
NUTOOL_CLOCK.g_Module.OPA = ['PCLK', 'OPA_EN', 'none'];
NUTOOL_CLOCK.g_Module.QEI0 = ['PCLK', 'QEI0_EN', 'none'];
NUTOOL_CLOCK.g_Module.QEI1 = ['PCLK', 'QEI1_EN', 'none'];
