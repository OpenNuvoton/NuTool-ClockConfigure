...
NUTOOL_CLOCK.g_CLKSEL.TMR0SEL = ['PCLK0:2', 'LIRC:4', 'EXT:3', 'HIRC:5']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR1SEL = ['PCLK0:2', 'LIRC:4', 'EXT:3', 'HIRC:5']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR2SEL = ['PCLK1:2', 'LIRC:4', 'EXT:3', 'HIRC:5']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR3SEL = ['PCLK1:2', 'LIRC:4', 'EXT:3', 'HIRC:5']; // 'external:3'
