...
NUTOOL_CLOCK.g_CLKSEL.TMR0SEL = ['PCLK0:2', 'EXT:3', 'LIRC:5', 'HIRC:7']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR1SEL = ['PCLK0:2', 'EXT:3', 'LIRC:5', 'HIRC:7']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR2SEL = ['PCLK1:2', 'EXT:3', 'LIRC:5', 'HIRC:7']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR3SEL = ['PCLK1:2', 'EXT:3', 'LIRC:5', 'HIRC:7']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR4SEL = ['PCLK0:2', 'EXT:3', 'LIRC:5', 'HIRC:7']; // 'external:3'
NUTOOL_CLOCK.g_CLKSEL.TMR5SEL = ['PCLK0:2', 'EXT:3', 'LIRC:5', 'HIRC:7']; // 'external:3'
