...
NUTOOL_CLOCK.g_register_map.CHIPPLLCTR1 = ['PLLSRC:2', 'PLL30M:1', 'PLLEN:0'];
...
NUTOOL_CLOCK.g_CLKSEL.PLLSRC = ['HRCCLK1:0', 'HXOCLK:1'];
...
NUTOOL_CLOCK.g_CLKSEL.PLLIDIV = ['PLLSRC:0', 'PLLSRC/2:1'];
