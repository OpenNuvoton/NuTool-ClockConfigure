...
NUTOOL_CLOCK.g_register_map.AHBCLK = ['CRCCKEN:7', 'HDIVCKEN:4', 'EBICKEN:3', 'ISPCKEN:2', 'PDMACKEN:1'];
NUTOOL_CLOCK.g_register_map.APBCLK0 = ['ADCCKEN:28', 'USBDCKEN:27', 'UART7CKEN:23', 'UART6CKEN:22', 'UART5CKEN:21', 'UART4CKEN:20', 'UART3CKEN:19', 'UART2CKEN:18', 'UART1CKEN:17', 'UART0CKEN:16', 'SPI0CKEN:13', 'QSPI0CKEN:12', 'I2C1CKEN:9', 'I2C0CKEN:8', 'ACMP01CKEN:7', 'CLKOCKEN:6', 'TMR3CKEN:5', 'TMR2CKEN:4', 'TMR1CKEN:3', 'TMR0CKEN:2', 'RTCCKEN:1', 'WDTCKEN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK1 = ['BPWM1CKEN:19', 'BPWM0CKEN:18', 'PWM1CKEN:17', 'PWM0CKEN:16', 'USCI1CKEN:9', 'USCI0CKEN:8'];
...
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['ADCSEL:21-20', 'BPWM1SEL:9', 'BPWM0SEL:8', 'SPI0SEL:5-4', 'QSPI0SEL:3-2', 'PWM1SEL:1', 'PWM0SEL:0'];
NUTOOL_CLOCK.g_register_map.CLKSEL3 = ['UART3SEL:30-28', 'UART2SEL:26-24', 'UART5SEL:22-20', 'UART4SEL:18-16', 'UART7SEL:14-12', 'UART6SEL:10-8'];
...
NUTOOL_CLOCK.g_register_map_default.CLKSEL1    = {
								"NuClockConfig": '0x4477773B',
								"NuCodeGenTool": '0x4477773B',
								"NuCodeGenTest": '0x3322223B'
};
NUTOOL_CLOCK.g_register_map_default.CLKSEL2    = {
								"NuClockConfig": '0x0020032B',
								"NuCodeGenTool": '0x0020032B',
								"NuCodeGenTest": '0x0000032B'
};
NUTOOL_CLOCK.g_register_map_default.CLKSEL3    = {
								"NuClockConfig": '0x44444400',
								"NuCodeGenTool": '0x44444400',
								"NuCodeGenTest": '0x33333300'
};
NUTOOL_CLOCK.g_register_map_default.PWRCTL     = {
								"NuClockConfig": '0x0231001F',
								"NuCodeGenTool": '0x0231001F',
								"NuCodeGenTest": '0x0271001F'
};
NUTOOL_CLOCK.g_register_map_default.AHBCLK     = {
								"NuClockConfig": '0x00000004',
								"NuCodeGenTool": '0x00000004',
								"NuCodeGenTest": '0x0000009E'
};
NUTOOL_CLOCK.g_register_map_default.APBCLK0    = {
								"NuClockConfig": '0x00000001',
								"NuCodeGenTool": '0x00000001',
								"NuCodeGenTest": '0x18FF33BF'
};
NUTOOL_CLOCK.g_register_map_default.APBCLK1    = {
								"NuClockConfig": '0x00000000',
								"NuCodeGenTool": '0x00000000',
								"NuCodeGenTest": '0x000F0003'
};
NUTOOL_CLOCK.g_register_map_default.PLLCTL     = {
								"NuClockConfig": '0x0005C25E',
								"NuCodeGenTool": '0x0005C25E',
								"NuCodeGenTest": '0x00084246'
};
NUTOOL_CLOCK.g_register_map_default.CLKOCTL    = '0x00000000';
NUTOOL_CLOCK.g_register_map_default.SYST_CTRL  = '0x00000000';
NUTOOL_CLOCK.g_register_map_default.RTC_LXTCTL = '0x00000000';
...
NUTOOL_CLOCK.g_CLKSEL.UART4SEL = ['HXT:0', 'PLL:1', 'LXT:2', 'HIRC:3', 'PCLK0:4', 'LIRC:5'];
NUTOOL_CLOCK.g_CLKSEL.UART5SEL = ['HXT:0', 'PLL:1', 'LXT:2', 'HIRC:3', 'PCLK1:4', 'LIRC:5'];
NUTOOL_CLOCK.g_CLKSEL.UART6SEL = ['HXT:0', 'PLL:1', 'LXT:2', 'HIRC:3', 'PCLK0:4', 'LIRC:5'];
NUTOOL_CLOCK.g_CLKSEL.UART7SEL = ['HXT:0', 'PLL:1', 'LXT:2', 'HIRC:3', 'PCLK1:4', 'LIRC:5'];
...
NUTOOL_CLOCK.g_unusedModule = {
	"M031FB0AE(TSSOP20)": ["LXT", "PLL", "TMR2", "TMR3", "USCI0", "USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "PWM1", "BPWM0", "BPWM1", "PDMA", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M031FC1AE(TSSOP20)": ["LXT", "PLL", "USCI0", "USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "PWM1", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M031EB0AE(TSSOP28)": ["LXT", "PLL", "TMR2", "TMR3", "USCI0", "USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "PWM1", "BPWM0", "BPWM1", "PDMA", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M031EC1AE(TSSOP28)": ["LXT", "PLL", "USCI0", "USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "PWM1", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M031TB0AE(QFN33)": ["LXT", "PLL", "TMR2", "TMR3", "USCI0", "USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "PWM1", "BPWM0", "BPWM1", "PDMA", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M031TC1AE(QFN33)": ["PLL", "USCI0", "USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "PWM1", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M032FC1AE(TSSOP20)": ["LXT", "HXT", "PLL", "TMR2", "TMR3", "USCI1", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "I2C0",  "I2C1", "PWM0", "PWM1", "BPWM1", "PDMA", "EBI", "HDIV", "RTC", "CLKO_1Hz", "ACMP01"],
	"M032EC1AE(TSSOP28)": ["LXT", "HXT", "PLL", "TMR2", "TMR3", "USCI1", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "I2C0",  "I2C1", "PWM0", "PWM1", "BPWM1", "PDMA", "EBI", "HDIV", "RTC", "CLKO_1Hz", "ACMP01"],
	"M032TC1AE(QFN33)": ["LXT", "HXT", "PLL", "TMR2", "TMR3", "USCI1", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "I2C0",  "I2C1", "PWM0", "PWM1", "BPWM1", "PDMA", "EBI", "HDIV", "RTC", "CLKO_1Hz", "ACMP01"],
	"M032TD2AE(QFN33)": ["LXT", "HXT", "PLL", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "I2C0",  "I2C1", "PWM0", "PWM1", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M032LC2AE(LQFP48)": ["LXT", "HXT", "PLL", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "I2C0",  "I2C1", "PWM0", "PWM1", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M032LD2AE(LQFP48)": ["LXT", "HXT", "PLL", "UART1", "UART2", "UART3", "UART4", "UART5", "UART6", "UART7", "I2C0",  "I2C1", "PWM0", "PWM1", "EBI", "RTC", "CLKO_1Hz", "ACMP01"],
	"M031TD2AE(QFN33)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz"],
	"M031TE3AE(QFN33)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz"],
	"M031LC2AE(LQFP48)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz"],
	"M031LD2AE(LQFP48)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz"],
	"M031LE3AE(LQFP48)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "RTC", "CLKO_1Hz"],
	"M031SC2AE(LQFP64)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz"],
	"M031SD2AE(LQFP64)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "EBI", "RTC", "CLKO_1Hz"],
	"M031SE3AE(LQFP64)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "USBD", "BPWM0", "BPWM1", "RTC", "CLKO_1Hz"],
	"M032LE3AE(LQFP48)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "BPWM0", "BPWM1", "RTC", "CLKO_1Hz"],
	"M032SE3AE(LQFP64)": ["USCI1", "UART3", "UART4", "UART5", "UART6", "UART7", "QSPI0", "BPWM0", "BPWM1", "RTC", "CLKO_1Hz"],
	"M031LG6AE(LQFP48)": ["UART6", "UART7", "USBD"],
	"M031LG8AE(LQFP48)": ["UART6", "UART7", "USBD"],
	"M031SG6AE(LQFP64)": ["UART6", "UART7", "USBD"],
	"M031SG8AE(LQFP64)": ["UART6", "UART7", "USBD"],
	"M031KG6AE(LQFP128)": ["UART6", "UART7", "USBD"],
	"M031KG8AE(LQFP128)": ["UART6", "UART7", "USBD"],
	"M032LG6AE(LQFP48)": ["UART6", "UART7"],
	"M032LG8AE(LQFP48)": ["UART6", "UART7"],
	"M032SG6AE(LQFP64)": ["UART6", "UART7"],
	"M032SG8AE(LQFP64)": ["UART6", "UART7"],
	"M032KG6AE(LQFP128)": ["UART6", "UART7"],
	"M032KG8AE(LQFP128)": ["UART6", "UART7"],
	"M031SIAAE(LQFP64)": ["USBD"],
	"M031KIAAE(LQFP128)": ["USBD"]
};
...
NUTOOL_CLOCK.g_BusFromPCLK1 = ['ACMP01', 'ADC', 'I2C1', 'PWM1', 'BPWM1', 'SPI0', 'TMR2', 'TMR3', 'UART1', 'UART3', 'UART5', 'UART7', 'USCI1', 'RTC'];
