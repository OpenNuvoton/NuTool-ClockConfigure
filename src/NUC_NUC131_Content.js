...
NUTOOL_CLOCK.g_register_map.APBCLK = ['ADC_EN:28', 'CAN0_EN:24', 'UART2_EN:18', 'UART1_EN:17', 'UART0_EN:16', 'SPI0_EN:12', 'I2C1_EN:9', 'I2C0_EN:8', 'FDIV_EN:6', 'TMR3_EN:5', 'TMR2_EN:4', 'TMR1_EN:3', 'TMR0_EN:2', 'WDT_EN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK1 = ['BPWM1_EN:19', 'BPWM0_EN:18', 'PWM1_EN:17', 'PWM0_EN:16', 'UART5_EN:10', 'UART4_EN:9', 'UART3_EN:8'];
NUTOOL_CLOCK.g_register_map.CLKSEL0 = ['STCLK_S:5-3', 'HCLK_S:2-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL1 = ['UART_S:25-24', 'TMR3_S:22-20', 'TMR2_S:18-16', 'TMR1_S:14-12', 'TMR0_S:10-8', 'SPI0_S:4', 'ADC_S:3-2', 'WDT_S:1-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['WWDT_S:17-16', 'FRQDIV_S:3-2'];
NUTOOL_CLOCK.g_register_map.CLKSEL3 = ['BPWM1_S:19', 'BPWM0_S:18', 'PWM1_S:17', 'PWM0_S:16'];
...
NUTOOL_CLOCK.g_register_map_default.CLKSEL3  = '0x000F003F';
...
NUTOOL_CLOCK.g_CLKSEL.BPWM0_S = ['PLL:0', 'PCLK:1'];
NUTOOL_CLOCK.g_CLKSEL.BPWM1_S = ['PLL:0', 'PCLK:1'];
NUTOOL_CLOCK.g_CLKSEL.FRQDIV_S = ['HXT:0', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.HCLK_S = ['HXT:0', 'PLL:2', 'LIRC:3', 'HIRC:7'];
NUTOOL_CLOCK.g_CLKSEL.PWM0_S = ['PLL:0', 'PCLK:1'];
NUTOOL_CLOCK.g_CLKSEL.PWM1_S = ['PLL:0', 'PCLK:1'];
...
NUTOOL_CLOCK.g_Module.BPWM0 = ['BPWM0_S', 'BPWM0_EN', 'none'];
NUTOOL_CLOCK.g_Module.BPWM1 = ['BPWM1_S', 'BPWM1_EN', 'none'];
...
NUTOOL_CLOCK.g_Module.PWM0 = ['PWM0_S', 'PWM0_EN', 'none'];
NUTOOL_CLOCK.g_Module.PWM1 = ['PWM1_S', 'PWM1_EN', 'none'];
...
NUTOOL_CLOCK.g_Module.UART3 = ['UART_S', 'UART3_EN', 'UART_N'];
NUTOOL_CLOCK.g_Module.UART4 = ['UART_S', 'UART4_EN', 'UART_N'];
NUTOOL_CLOCK.g_Module.UART5 = ['UART_S', 'UART5_EN', 'UART_N'];
