...
NUTOOL_CLOCK.g_register_map.AHBCLK = ['GPFCKEN:29','GPECKEN:28','GPDCKEN:27','GPCCKEN:26','GPBCKEN:25','GPACKEN:24','FMCIDLE:15','CRPTCKEN:12','CRCCKEN:7','EBICKEN:3','ISPCKEN:2','PDMACKEN:1'];
NUTOOL_CLOCK.g_register_map.APBCLK0 = ['EADCCKEN:28','USBDCKEN:27','UART2CKEN:18','UART1CKEN:17','UART0CKEN:16','SPI0CKEN:13', 'QSPI0CKEN:12','I2C1CKEN:9','I2C0CKEN:8','ACMP01CKEN:7','CLKOCKEN:6','TMR3CKEN:5','TMR2CKEN:4','TMR1CKEN:3','TMR0CKEN:2','RTCCKEN:1','WDTCKEN:0'];
NUTOOL_CLOCK.g_register_map.APBCLK1 = ['PSIOCKEN:31','OPACKEN:30','BPWM1CKEN:19','BPWM0CKEN:18','PWM1CKEN:17','PWM0CKEN:16','DACCKEN:12','USCI2CKEN:10','USCI1CKEN:9','USCI0CKEN:8','SC0CKEN:0'];
...
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['PSIOSEL:30-28','BPWM1SEL:9','BPWM0SEL:8','SPI0SEL:5-4','QSPI0SEL:3-2','PWM1SEL:1','PWM0SEL:0'];
NUTOOL_CLOCK.g_register_map.CLKSEL3 = ['UART2SEL:26-24', 'SC0SEL:1-0'];
...
NUTOOL_CLOCK.g_register_map_default.CLKSEL0    = {
							"NuClockConfig":     '0x0000003D',
							"NuClockConfigTest": '0x0000003D',
							"NuCodeGenTool":     '0x0000003D',
							"NuCodeGenTest":     '0x0000003F'
};
NUTOOL_CLOCK.g_register_map_default.CLKSEL1    = '0x4477773B';
NUTOOL_CLOCK.g_register_map_default.CLKSEL2    = '0x2000032B';
NUTOOL_CLOCK.g_register_map_default.CLKSEL3    = '0x04000003';
...
NUTOOL_CLOCK.g_register_map_default.RTC_LXTCTL = '0x780F010E';
...
NUTOOL_CLOCK.g_unusedModule = {
	"M251FC2AE": ["PLL", "LXT", "BPWM0", "BPWM1", "RTC", "CLKO_1Hz", "USCI1", "USCI2", "UART2", "SPI0", "EBI", "PSIO", "ACMP01", "DAC", "OPA", "USBD"],
	"M251EC2AE": ["PLL", "LXT", "BPWM0", "BPWM1", "RTC", "CLKO_1Hz", "USCI1", "USCI2", "UART2", "SPI0", "EBI", "PSIO", "ACMP01", "DAC", "OPA", "USBD"],
	"M251ZC2AE": ["PLL",  "BPWM0", "BPWM1", "USCI1", "USCI2", "UART2", "SPI0", "EBI", "PSIO", "ACMP01", "DAC", "OPA", "USBD"],
	"M251ZD2AE": ["USCI2", "EBI", "DAC", "OPA", "USBD"],
	"M251LC2AE": ["USCI2", "EBI", "DAC", "OPA", "USBD"],
	"M251LD2AE": ["USCI2", "EBI", "DAC", "OPA", "USBD"],
	"M251SC2AE": ["USCI2", "EBI", "DAC", "OPA", "USBD"],
	"M251SD2AE": ["USCI2", "EBI", "DAC", "OPA", "USBD"],
	"M251LE3AE": ["DAC", "OPA", "USBD"],
	"M251LG6AE": ["USBD"],
	"M251SE3AE": ["DAC", "OPA", "USBD"],
	"M251SG6AE": ["USBD"],
	"M251KE3AE": ["DAC", "OPA", "USBD"],
	"M251KG6AE": ["USBD"],
	"M252FC2AE": ["PLL", "LXT",  "BPWM0", "BPWM1", "RTC", "CLKO_1Hz", "USCI1", "USCI2", "UART2", "SPI0", "EBI", "PSIO", "ACMP01", "DAC", "OPA"],
	"M252EC2AE": ["PLL", "LXT",  "BPWM0", "BPWM1", "RTC", "CLKO_1Hz", "USCI1", "USCI2", "UART2", "SPI0", "EBI", "PSIO", "ACMP01", "DAC", "OPA"],
	"M252ZC2AE": ["PLL",  "BPWM0", "BPWM1", "USCI1", "USCI2", "UART2", "SPI0", "EBI", "PSIO", "ACMP01", "DAC", "OPA"],
	"M252ZD2AE": ["USCI2", "EBI", "DAC", "OPA"],
	"M252LC2AE": ["USCI2", "EBI", "DAC", "OPA"],
	"M252LD2AE": ["USCI2", "EBI", "DAC", "OPA"],
	"M252LE3AE": ["DAC", "OPA"],
	"M252SC2AE": ["USCI2", "EBI", "DAC", "OPA"],
	"M252SD2AE": ["USCI2", "EBI", "DAC", "OPA"],
	"M252SE3AE": ["DAC", "OPA"],
	"M252KE3AE": ["DAC", "OPA"]
};
...
NUTOOL_CLOCK.g_BusFromPCLK1 = ['ACMP01', 'BPWM1', 'DAC', 'EADC', 'I2C1', 'PSIO', 'PWM1', 'SPI0', 'TMR2', 'TMR3', 'UART1', 'USCI1'];
