...
NUTOOL_CLOCK.g_register_map.AHBCLK = ['ISP_EN:2', 'PDMA_EN:1'];
NUTOOL_CLOCK.g_register_map.APBCLK = ['PS2_EN:31', 'I2S_EN:29', 'ADC_EN:28', 'USBD_EN:27', 'PWM23_EN:21', 'PWM01_EN:20', 'UART1_EN:17', 'UART0_EN:16', 'SPI2_EN:14', 'SPI1_EN:13', 'SPI0_EN:12', 'I2C1_EN:9', 'I2C0_EN:8', 'FDIV_EN:6', 'TMR3_EN:5', 'TMR2_EN:4', 'TMR1_EN:3', 'TMR0_EN:2', 'WDT_EN:0'];
NUTOOL_CLOCK.g_register_map.CLKSEL0 = ['STCLK_S:5-3', 'HCLK_S:2-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL1 = ['PWM23_S:31-30', 'PWM01_S:29-28', 'UART_S:25-24', 'TMR3_S:22-20', 'TMR2_S:18-16', 'TMR1_S:14-12', 'TMR0_S:10-8', 'SPI2_S:6', 'SPI1_S:5', 'SPI0_S:4', 'ADC_S:3-2', 'WDT_S:1-0'];
NUTOOL_CLOCK.g_register_map.CLKSEL2 = ['WWDT_S:17-16', 'PWM23_S_E:9', 'PWM01_S_E:8', 'FRQDIV_S:3-2', 'I2S_S:1-0'];
NUTOOL_CLOCK.g_register_map.CLKDIV = ['ADC_N:23-16', 'UART_N:11-8', 'USB_N:7-4', 'HCLK_N:3-0'];
NUTOOL_CLOCK.g_register_map.APBDIV = ['PCLK_S:0'];
...
NUTOOL_CLOCK.g_register_map_description.APBDIV   = '0x5000022C';
...
NUTOOL_CLOCK.g_CLKSEL.HCLK_S = ['HXT:0', 'PLL/2:1', 'PLL:2', 'LIRC:3', 'HIRC:7'];
NUTOOL_CLOCK.g_CLKSEL.I2S_S = ['HXT:0', 'PLL:1', 'HCLK:2', 'HIRC:3'];
NUTOOL_CLOCK.g_CLKSEL.PWM01_S = ['HXT:0', 'HCLK:2', 'HIRC:3', 'LIRC:7'];
NUTOOL_CLOCK.g_CLKSEL.PWM23_S = ['HXT:0', 'HCLK:2', 'HIRC:3', 'LIRC:7'];
...
NUTOOL_CLOCK.g_CLKSEL.PCLK_S = ['HCLK:0', 'HCLK/2:1'];
...
NUTOOL_CLOCK.g_unusedModule = {
	"NUC123ZD4AN0": ["UART0", "I2C0", "PS2", "PWM01"],
	"NUC123ZC2AN1": ["UART0", "I2C0", "PS2", "PWM01"],

	"NUC123ZD4AE0": ["UART0", "I2C0", "PS2"],
	"NUC123ZC2AE1": ["UART0", "I2C0", "PS2"]
};
