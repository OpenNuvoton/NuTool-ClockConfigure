...
!macro preInit
    SetRegView 64
    WriteRegExpandStr HKLM "${INSTALL_REGISTRY_KEY}" InstallLocation "C:\Program Files (x86)\Nuvoton Tools\NuTool-ClockConfigure"
    WriteRegExpandStr HkCU "${INSTALL_REGISTRY_KEY}" InstallLocation "C:\Program Files (x86)\Nuvoton Tools\NuTool-ClockConfigure"
    SetRegView 32
    WriteRegExpandStr HKLM "${INSTALL_REGISTRY_KEY}" InstallLocation "C:\Program Files (x86)\Nuvoton Tools\NuTool-ClockConfigure"
    WriteRegExpandStr HkCU "${INSTALL_REGISTRY_KEY}" InstallLocation "C:\Program Files (x86)\Nuvoton Tools\NuTool-ClockConfigure"
!macroend
